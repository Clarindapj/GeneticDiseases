...
My primary focus has always been on `Biology, Biotechnology, and Bioinformatics.` I find particular interest in how genetic information can be harnessed in `medical research.` To advance this knowledge, I am currently learning about `data science`, which `applies computer science methods to biological research.` This activity is a great step towards integrating these areas and allows me to apply data science principles into research of genetic diseases.

This project was quite challenging, but it was also worthwhile. Although my background is in Biotechnology and Bioinformatics, as I worked on this project, I found myself learning to think critically about the problems at hand and to think logically and computationally in ways that I did not think were possible before. This endeavor has made me a better programmer, but more importantly, it has altered how I think of data science as a discipline and its value to the field of genetics. I look forward to additional and sustained improvement as a result of being able to perform work of this nature.
